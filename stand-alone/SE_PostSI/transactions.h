...
extern int newOrderTransaction(int w_id, int d_id, int c_id, int o_ol_cnt, int o_all_local, int *itemIDs, int *supplierWarehouseIDs, int *orderQuantities);

extern int paymentTransaction(int w_id, int c_w_id, int h_amount, int d_id, int c_d_id, int c_id);

extern int deliveryTransaction(int w_id, int o_carrier_id);

extern int orderStatusTransaction(int w_id, int d_id, int c_id);

extern int stockLevelTransaction(int w_id, int d_id, int threshold);
