...
extern int IsWrLockHolding(uint32_t table_id, TupleId tuple_id, int node_id);

extern int IsRdLockHolding(uint32_t table_id, TupleId tuple_id, int node_id);

extern int IsDataLockExist(int table_id, TupleId tuple_id, int node_id, LockMode mode);
